...
USERNAME = environ.get('USERNAME', "https://telegram.me/jain_shabb_bot")
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://Geeta05:Geeta05@geeta05.dmkbmwt.mongodb.net/?retryWrites=true&w=majority")

DATABASE_NAME = environ.get('DATABASE_NAME', "Geeta05")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')
LOG_API_CHANNEL = int(environ.get('LOG_API_CHANNEL', '-1002028285534'))
QR_CODE = environ.get('QR_CODE', 'https://graph.org/file/b30df594254f190695cc7.jpg')
START_IMG = environ.get('START_IMG', 'https://graph.org/file/130d22d88710248c45b26.jpg')
BIN_CHANNEL = int(environ.get('BIN_CHANNEL','-1001603494534'))
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002187836754'))
URL = environ.get('URL', '')
STICKERS_IDS = ('CAACAgQAAxkBAAEK99dlfC7LDqnuwtGRkIoacot_dGC4zQACbg8AAuHqsVDaMQeY6CcRojME').split()
FILE_AUTO_DEL_TIMER = int(environ.get('FILE_AUTO_DEL_TIMER', '600'))
IS_VERIFY = is_enabled('IS_VERIFY', True)
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002028285534'))
...
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002240357174'))
request_channel = environ.get('REQUEST_CHANNEL', '-1002087314786')
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
UPI_PAY_LOGS = int(environ.get('UPI_PAY_LOGS', '-1002038597402'))
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002141346688'))
